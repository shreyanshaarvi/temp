...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => _RouteErrorBuilder(
        state: state,
        child: appStateNotifier.loggedIn ? const HomePageWidget() : const Auth1Widget(),
      ),
      routes: [
        FFRoute(
          name: '_initialize',
          ...
          routes: [
            ...
            FFRoute(
              name: 'NesteedPage',
              path: 'nesteedPage',
              builder: (context, params) => const NesteedPageWidget(),
            ),
            FFRoute(
              name: 'Chart',
              path: 'chart',
              builder: (context, params) => const ChartWidget(),
            )
